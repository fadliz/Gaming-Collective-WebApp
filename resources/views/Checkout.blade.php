        ...
        <div class="container bg-default p-5">
            ...
            <form>
                <div class="form-row">
                    ...
                    <input type="text" class="form-control" id="adress" placeholder="Contoh : Jl. Segar Hurip No.12"
                        required />
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" class="form-control" id="Kota-name" placeholder="Contoh : Kota Bandung"
                            required />
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" class="form-control" id="Kecamatan-name"
                            placeholder="Contoh : Kecamatan Bojongsoang" required />
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" class="form-control" id="Kodepos-name" placeholder="Contoh : 40287"
                            required />
                        <div class="invalid-feedback">
                            Masukkan kode pos.
                        </div>
                ...
                <hr class="mb-4" />
                <button class="btn btn-primary bt-lg btn-block" type="submit" data-bs-toggle="modal"
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0"
                    style="color : #fffdfd !important;  background-color : #333333 !important; ">
                    <div class="modal-header border-0">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Berhasil !</h1>
                        <button type="button" class="btn-close" style="background-color : #fffdfd;"
                    ...
                    <div class="modal-footer border-0">
                        ...
                        <a href="/HistoryPembelian"><button type="button" class="btn btn-primary">Liat history
                                pembelian</button></a>
                    </div>
                </div>
            </div>
