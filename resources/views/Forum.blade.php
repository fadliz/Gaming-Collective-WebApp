          ...
          <div class="comment-thread mb-3">
            ...
            <div class="comment" id="comment-1">
              ...
              <div class="comment-heading">
                <div class="card-header">
                  <img src="storage/{{ $item->user->profile }}" alt="" width="36" height="36"
                    class="rounded-circle me-2" />
                </div>
                ...
                @if (auth()->user()->id == $item->User_id)
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="/hapusForum/{{ $item->id }}"
                        style="color : #ff1f57;">Delete post</a></li>
                  </ul>
                @endif
              </div>
              <div class="comment-body">
                ...
                <button onclick="topFunction()" type="button" data-toggle="reply-form"
                ...
                <div class="replies">
                  ...
                  <details open class="comment" id="comment-2">
                    ...
                    <summary>
                      <div class="comment-heading">
                        <div class="card-header">
                          <img src="storage/{{ $bales->user->profile }}" alt="" width="36" height="36"
                            class="rounded-circle me-2" />
                        </div>
                        <div class="comment-info">
                          <a href="#" class="comment-author">{{ $bales->user->username }}</a>
                          <p class="m-0">
                            {{ $bales->forum->Category->nama }} &bull;
                            {{ \Carbon\Carbon::parse($bales->created_at)->diffForHumans() }}
                          </p>
                        </div>
                      </div>
                    </summary>
